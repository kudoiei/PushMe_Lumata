...
public class PushMe extends Application
{
   ...
   public void start(Stage stage)
   {
      ...
      Button capitalButton = new Button();
      capitalButton.setText("Convert to Upper Case");
      capitalButton.setOnAction(
         e -> {
      ...
      root.getChildren().addAll(pushMeTextField, pushMeButton, capitalButton, lowerCaseButton, pushMeLabel);
